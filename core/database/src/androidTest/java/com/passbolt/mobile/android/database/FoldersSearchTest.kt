...
import net.svaroh.passly.database.FoldersSearchTest.SearchFolderStructure.FOLDER_4
import net.svaroh.passly.database.FoldersSearchTest.SearchFolderStructure.FOLDER_5
import net.svaroh.passly.database.FoldersSearchTest.SearchFolderStructure.RESOURCE_1
import net.svaroh.passly.database.FoldersSearchTest.SearchFolderStructure.RESOURCE_2
import net.svaroh.passly.database.FoldersSearchTest.SearchFolderStructure.RESOURCE_3
import net.svaroh.passly.database.FoldersSearchTest.SearchFolderStructure.RESOURCE_4
import net.svaroh.passly.database.FoldersSearchTest.SearchFolderStructure.RESOURCE_5
