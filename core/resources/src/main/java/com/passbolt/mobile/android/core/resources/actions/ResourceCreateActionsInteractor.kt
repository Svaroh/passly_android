...
import net.svaroh.passly.core.commonfolders.usecase.db.ItemIdResourceId
import net.svaroh.passly.core.resources.actions.ResourceCreateActionResult.CannotCreateWithCurrentConfig
import net.svaroh.passly.core.resources.actions.ResourceCreateActionResult.CryptoFailure
import net.svaroh.passly.core.resources.actions.ResourceCreateActionResult.Failure
import net.svaroh.passly.core.resources.actions.ResourceCreateActionResult.FetchFailure
import net.svaroh.passly.core.resources.actions.ResourceCreateActionResult.JsonSchemaValidationFailure
import net.svaroh.passly.core.resources.actions.ResourceCreateActionResult.MetadataKeyDeleted
import net.svaroh.passly.core.resources.actions.ResourceCreateActionResult.MetadataKeyModified
import net.svaroh.passly.core.resources.actions.ResourceCreateActionResult.ShareFailure
import net.svaroh.passly.core.resources.actions.ResourceCreateActionResult.SimulateShareFailure
import net.svaroh.passly.core.resources.actions.ResourceCreateActionResult.Success
import net.svaroh.passly.core.resources.actions.ResourceCreateActionResult.Unauthorized
...
import net.svaroh.passly.metadata.interactor.MetadataPrivateKeysInteractor.Output.TrustedKeyDeleted
